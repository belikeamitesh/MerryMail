...
import Pig from "../Assets/Icons/x.png"
...
function Signup() {
   ...
   return (
    <div className='Signup'>
        ...
        <div className='signup-home'>
            ...
            <div className='Signup-head'>
                ...
                <div className='Signup-subhead'>
                    Create account to design and send cards to your loved ones
                </div>
            </div>
        ...
        <h2>Welcome to MerryMail</h2>
            <p>Make your awesome christmas cards here and send it to your loved ones!</p>
        </div>
